                                ...
                                <table class="table table-bordered table-striped table-dark" id="dataTable" width="100%" cellspacing="0" >
                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td><a href=" <?php echo base_url('products/delete/'.$item['product_id']); ?>" class="btn btn-danger"><i class="fa fa-trash">Delete</i></a>
                                           <a href=" <?php echo base_url('products/edit/'.$item['product_id']);  ?>" class="btn btn-success"><i class="fa fa-edit"></i>Edit</a></td>
